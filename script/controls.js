...
* @version $Id: controls.js 38885 2013-10-21 10:11:40Z weinert $
*/
...
jQuery(document).ready(
  function() {
    ...
    jQuery('input.dialogInputDate,input.dialogInputDateTime,input.dialogInputSuggest').each(
      function() {
    ...
    jQuery('input.dialogInputSuggest').papayaDialogFieldSuggest({});
