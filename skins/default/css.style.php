...
* @version $Id: css.style.php 39752 2014-04-24 10:55:28Z weinert $
...
form.dialog .caption.mandatory span.text:after {
  content: ' *';
}
form.dialog .hint {
  font-size: 11px;
...
.dialogField .suggest a {
  display: block;
  padding: 5px;
}
.dialogField .suggest a:hover {
  background: #9EAB2D;
}
