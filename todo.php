...
* @version $Id: todo.php 39752 2014-04-24 10:55:28Z weinert $
*/
...
if ($PAPAYA_SHOW_ADMIN_PAGE) {
  $PAPAYA_LAYOUT->parameters()->set(
    'PAGE_TITLE', _gt('General').' - '._gt('Messages').' - '._gt('Tasks')
  );
  $PAPAYA_LAYOUT->parameters()->set('PAGE_ICON', $PAPAYA_IMAGES['items-task']);
